...
= 1.4.10 =
* الرئيسية تقرأ نفس جداول القالب السابق فقط: HomeIntro + widgets_home__meta (ودجات widgets__posts). لا نظام kayan-homepage.
* إيقاف التلقيم التلقائي للمحتوى عند التفعيل/التحميل — لا يُفرض مدن أو خدمات أو نصوص دولة. التلقيم اليدوي اختياري من لوحة التحكم.
* لا خريطة دبي ولا عنوان إماراتي ولا شعار «ركن التطور» عند فراغ الحقول — يُستخدم اسم الموقع والإعدادات الفعلية فقط.
* عيّنات الودجات الجغرافية لا تظهر إلا إذا فعّل المدير «المحتوى الافتراضي» يدوياً.
