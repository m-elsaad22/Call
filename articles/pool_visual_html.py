...
<p>حتى مع زيارة دورية، سلة السكimmer والمسار حول الحوض يؤثران على سرعة اتساخ الماء. تفريغ السلة من الأوراق، وتشغيل الدورة يوميًا في الصيف، وتجنيب رمي الطعام في الحوض يقلّل جهد التنظيف التالي في {city}.</p>
{cards([
...
<p>معظم أعطال {city} تبدأ من غرفة غير مهواة أو أرضية غارقة. المضخة فوق ماء راكد تفسد اللفات، والكابل المبلل يفصل القاطع. أثناء المعاينة ننظر إلى التصريف والتهوية قبل الحديث عن استبدال جهاز جديد.</p>
{cards([
...
<p>العزل يُختار حسب نوع الحوض لا حسب أرخص لفة في السوق. خطأ هنا يظهر بعد الملء: نمش، أو تقشير بلاط، أو فقد ماء. في {city} نفضّل تثبيت تفاصيل العزل والتمديد كتابيًا قبل البلاط حتى لا يُعاد الفتح لاحقًا.</p>
{cards([
